...
import type { CopilotMessage, CopilotScopeMode, CopilotThreadSummary } from "./global-ai-copilot-types";
import {
  ...
  normalizePageKey,
  resolvePageName,
  resolveRoleQuickPrompts,
  scopeModeOptions,
  scopeModeLabel,
  shouldRenderAssistantArtifacts
} from "./global-ai-copilot-utils";
